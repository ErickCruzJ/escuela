...
export default function Edit({ carrera }: { carrera: Carrera}){
    ...
    return (
        <div className="mx-auto max-w-2xl">
            <div className="rounded-xl border-gray-200 bg-white shadow-sm">
                <div className="border-b border-gray-200 px-6 py-4">
                    <h1 className="text-2-xl font-bold text-gray-800">
                        Editar Carrera
                    </h1>
                ...
                >
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blie-500 focus:outline-none focus:rig-2 focus:ring-blue-200"
                        />
                        {errors.nombre &&(
